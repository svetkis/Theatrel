...
public class TgBotTests : IClassFixture<DatabaseFixture>
{
    ...
    [Theory]
    [InlineData(1, 5, new[] { DayOfWeek.Monday }, "концерт", false, "/search", "Любая", "апрель", "Нет!", "май", "Суббота", "нет", "понедельник", "кОнцерт", "Подписаться на новые спектакли и появление билетов в продаже")]
